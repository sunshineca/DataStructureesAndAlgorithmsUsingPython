...
class Date:
    ...
    # exercise 1.1
    def monthName(self):
        names = ['Jan', 'Feb', 'Mar', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
...
date1 = Date(2,7,1800)
date2 = Date(2,7,1982)
print(date1.monthName())
print(date1.isLeapyear())
print(date1.__eq__(date2))
#print type(date1._julianDay)
print("julianDay of date1 is: %i" % date1._julianDay)
print(type(date1))
print ("date1 is:", date1.__str__())
#print type(day_date1)
print("date1 is %d/%d/%d!" % (date1.month(), date1.day(), date1.year())) 
print(dir(Date))